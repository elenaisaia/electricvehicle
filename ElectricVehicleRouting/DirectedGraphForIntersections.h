...
public:
    ...
    DirectedGraphForIntersections generateGraph(unsigned int noOfChargingStations, unsigned int noOfIntersections, double maxDistance, const std::string& fileName);
