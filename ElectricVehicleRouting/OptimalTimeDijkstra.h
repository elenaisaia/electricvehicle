#ifndef ELECTRICVEHICLEROUTING_OPTIMALTIMEDIJKSTRA_H
#define ELECTRICVEHICLEROUTING_OPTIMALTIMEDIJKSTRA_H
...
#endif //ELECTRICVEHICLEROUTING_OPTIMALTIMEDIJKSTRA_H
